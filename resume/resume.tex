...
\section{Awards}
\resumeSubHeadingListStart
    \resumeSubItem{Project rank 1/126}{PBQP based register allocator project secured first place at VIT, Pune}
      \resumeSubItem{Competitive Programming}{\textbf{Rank 2/66} in \href{https://www.kaggle.com/c/hw2-activity-recognition-cse512-spr18/leaderboard}{Kaggle Competition} for Human Acticity Recognition; \textbf{Rank 1/600} at programming contest(C-Athlon); Qualified for \textbf{ACM ICPC} Amritapuri regionals}
   \resumeSubHeadingListEnd
%-------------------------------------------
