...
\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
  ...
  \href{https://github.com/bhushan23}{github.com/bhushan23} & Mobile: N/A \\
\end{tabular*}
...
%    \resumeSubItem{MaskGAN with Attention model for filling the missing words}{Extending MaskGAN for filling the missing word with attention model for long sentences [Python, PyTorch, Ongoing]}
